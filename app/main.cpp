...
int main(int argc, char* argv[])
{
    ...
    if (treeConfig.type == TreeType::QUADTREE)
    {
        RunAppQuadTree(treeConfig, renderConfig, appConfig);    
    }
    else if (treeConfig.type == TreeType::OCTREE)
    {
        RunAppOctree(treeConfig, renderConfig, appConfig);
    }
